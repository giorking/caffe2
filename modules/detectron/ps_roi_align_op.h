...
#ifndef PS_ROI_ALIGN_OP_H_
#define PS_ROI_ALIGN_OP_H_
...
class PSRoIAlignOp final : public Operator<Context> {
 public:
...
template <typename T, class Context>
class PSRoIAlignGradientOp final : public Operator<Context> {
 public:
  PSRoIAlignGradientOp(const OperatorDef& def, Workspace* ws)
